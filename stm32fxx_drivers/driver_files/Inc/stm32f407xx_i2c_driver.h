...
/*
 * Configuration structure for I2Cx peripheral (user configures these on their program)
 */
typedef struct
{
	uint32_t I2C_SLCSpeed;				/*!< @I2C_SLCSpeed >*/
...
typedef struct
{
	...
	I2C_Config_t	I2CConfig;		 /*!< This holds the user configuration settings >*/
	uint8_t			*pTxBuffer;		 /*!< To store the application's Tx buffer address >*/
...
/*
 *  I2C related status flags definitions (on status register)
 */
...
void I2C_Init(I2C_Handle_t *pI2CHandle);			//parameters: a pointer to the handle structure
void I2C_DeInit(I2C_RegDef_t *pI2Cx);		// Deinitialize
